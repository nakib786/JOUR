...
import { onAuthStateChange, signInWithGoogle, signInWithEmail, logout, isAdmin } from '@/lib/firebase/auth';
import { 
  createPost, 
  getPosts, 
  updatePost, 
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8">
            ...
            <div className="space-y-4">
              <button
                ...
                className="w-full flex items-center justify-center gap-3 bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-lg px-4 py-3 text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-600 transition-colors duration-200"
              >
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-2 bg-rose-500 text-white rounded-lg px-4 py-3 hover:bg-rose-600 transition-colors duration-200"
              >
